...
class AlertController {
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray ta = context.obtainStyledAttributes(attrs, C0275R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = ta.getDimensionPixelOffset(C0275R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = ta.getDimensionPixelOffset(C0275R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0275R.attr.alertDialogCenterButtons, outValue, true);
        if (outValue.data != 0) {
            return true;
        }
        return false;
    ...
    public AlertController(Context context, AppCompatDialog di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null, C0275R.styleable.AlertDialog, C0275R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = a.getResourceId(C0275R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = a.getResourceId(C0275R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = a.getResourceId(C0275R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = a.getResourceId(C0275R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = a.getResourceId(C0275R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = a.getResourceId(C0275R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = a.getBoolean(C0275R.styleable.AlertDialog_showTitle, true);
        a.recycle();
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0275R.C0277id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0275R.C0277id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0275R.C0277id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0275R.C0277id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0275R.C0277id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0275R.C0277id.topPanel);
        View customContentPanel = customPanel.findViewById(C0275R.C0277id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0275R.C0277id.buttonPanel);
        ...
        if (!hasButtonPanel && contentPanel != null) {
            View spacer = contentPanel.findViewById(C0275R.C0277id.textSpacerNoButtons);
            if (spacer != null) {
        ...
        if (hasTopPanel) {
            ...
            if (!(this.mMessage == null && this.mListView == null && !hasCustomPanel) && !hasCustomPanel) {
                divider = topPanel.findViewById(C0275R.C0277id.titleDividerNoCustom);
            }
            if (divider != null) {
                divider.setVisibility(0);
            }
        } else if (contentPanel != null) {
            View spacer2 = contentPanel.findViewById(C0275R.C0277id.textSpacerNoTitle);
            if (spacer2 != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0275R.C0277id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0275R.C0277id.scrollIndicatorDown);
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = (FrameLayout) this.mWindow.findViewById(C0275R.C0277id.custom);
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0275R.C0277id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0275R.C0277id.alertTitle);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0275R.C0277id.scrollView);
