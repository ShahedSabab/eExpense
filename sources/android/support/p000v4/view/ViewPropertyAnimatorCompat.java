...
public final class ViewPropertyAnimatorCompat {
    ...
    static class BaseViewPropertyAnimatorCompatImpl implements ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        public void mo4344x(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: y */
        public void mo4346y(ViewPropertyAnimatorCompat vpa, View view, float value) {
            postStartMessage(vpa, view);
        }
        ...
        /* renamed from: z */
        public void mo4348z(ViewPropertyAnimatorCompat vpa, View view, float value) {
        }
    ...
    interface ViewPropertyAnimatorCompatImpl {
        ...
        /* renamed from: x */
        void mo4344x(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void xBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: y */
        void mo4346y(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        void yBy(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);

        /* renamed from: z */
        void mo4348z(ViewPropertyAnimatorCompat viewPropertyAnimatorCompat, View view, float f);
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo4306x(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo4344x(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo4308y(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo4346y(this, view, value);
        }
        return this;
    }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo4310z(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
            IMPL.mo4348z(this, view, value);
        }
        return this;
    }
