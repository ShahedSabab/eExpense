...
public interface zzq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzq {
        ...
        private static class C0738zza implements zzq {
            private IBinder zzajq;

            C0738zza(IBinder iBinder) {
                this.zzajq = iBinder;
            }
        ...
        public static zzq zzds(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzq)) ? new C0738zza(iBinder) : (zzq) queryLocalInterface;
        }
