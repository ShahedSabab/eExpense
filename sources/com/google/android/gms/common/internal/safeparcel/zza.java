...
public class zza {
    ...
    public static class C0735zza extends RuntimeException {
        public C0735zza(String str, Parcel parcel) {
    ...
    private static void zza(Parcel parcel, int i, int i2) {
        ...
        if (zza != i2) {
            ...
            throw new C0735zza(new StringBuilder(String.valueOf(valueOf).length() + 46).append("Expected size ").append(i2).append(" got ").append(zza).append(" (0x").append(valueOf).append(")").toString(), parcel);
        }
    }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        if (i2 != i3) {
            ...
            throw new C0735zza(new StringBuilder(String.valueOf(valueOf).length() + 46).append("Expected size ").append(i3).append(" got ").append(i2).append(" (0x").append(valueOf).append(")").toString(), parcel);
        }
    }
    ...
    public static int zzcr(Parcel parcel) {
        ...
        if (zzgu(zzcq) != 20293) {
            ...
            throw new C0735zza(valueOf.length() != 0 ? str.concat(valueOf) : new String(str), parcel);
        }
        int i = dataPosition + zza;
        if (i >= dataPosition && i <= parcel.dataSize()) {
            return i;
        }
        throw new C0735zza("Size read is invalid start=" + dataPosition + " end=" + i, parcel);
    }
