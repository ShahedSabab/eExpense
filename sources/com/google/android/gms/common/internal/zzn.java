...
public class zzn {
    ...
    /* renamed from: Ey */
    private static final Uri f350Ey = Uri.parse("http://plus.google.com/");

    /* renamed from: Ez */
    private static final Uri f351Ez = f350Ey.buildUpon().appendPath("circles").appendPath("find").build();
