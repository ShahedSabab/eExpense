...
public interface zzv extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzv {
        ...
        private static class C0742zza implements zzv {
            private IBinder zzajq;

            C0742zza(IBinder iBinder) {
                this.zzajq = iBinder;
            }
        ...
        public static zzv zzdw(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzv)) ? new C0742zza(iBinder) : (zzv) queryLocalInterface;
        }
