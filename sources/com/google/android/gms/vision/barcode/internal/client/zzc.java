...
public interface zzc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzc {
        ...
        private static class C0765zza implements zzc {
        ...
        public static zzc zzle(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzc)) ? new C0765zza(iBinder) : (zzc) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                case 1:
                    ...
                    Barcode[] zza = zza(zzfd, frameMetadataParcel);
                    parcel2.writeNoException();
                    parcel2.writeTypedArray(zza, 1);
                    return true;
                case 2:
                    parcel.enforceInterface("com.google.android.gms.vision.barcode.internal.client.INativeBarcodeDetector");
                    zzd zzfd2 = com.google.android.gms.dynamic.zzd.zza.zzfd(parcel.readStrongBinder());
                    if (parcel.readInt() != 0) {
                        frameMetadataParcel = (FrameMetadataParcel) FrameMetadataParcel.CREATOR.createFromParcel(parcel);
                    }
                    Barcode[] zzb = zzb(zzfd2, frameMetadataParcel);
                    parcel2.writeNoException();
