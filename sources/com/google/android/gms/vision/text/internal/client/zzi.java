...
public class zzi implements Creator<WordBoxParcel> {
    static void zza(WordBoxParcel wordBoxParcel, Parcel parcel, int i) {
        ...
        zzb.zza(parcel, 2, (T[]) wordBoxParcel.aPb, i, false);
        zzb.zza(parcel, 3, (Parcelable) wordBoxParcel.aOR, i, false);
        zzb.zza(parcel, 4, (Parcelable) wordBoxParcel.aOS, i, false);
