...
public class zzs {
    ...
    static class zza {
        ...
        private final List<C0755zza> zzbk = new ArrayList();
        ...
        private static class C0755zza {
            public final String name;
            public final long time;
            public final long zzbm;

            public C0755zza(String str, long j, long j2) {
                this.name = str;
                this.zzbm = j;
                this.time = j2;
            }
        ...
        private long getTotalDuration() {
            ...
            return ((C0755zza) this.zzbk.get(this.zzbk.size() - 1)).time - ((C0755zza) this.zzbk.get(0)).time;
        }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzbk.add(new C0755zza(str, j, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void zzd(String str) {
            ...
            if (totalDuration > 0) {
                long j = ((C0755zza) this.zzbk.get(0)).time;
                zzs.zzb("(%-4d ms) %s", Long.valueOf(totalDuration), str);
                long j2 = j;
                for (C0755zza zza : this.zzbk) {
                    long j3 = zza.time;
