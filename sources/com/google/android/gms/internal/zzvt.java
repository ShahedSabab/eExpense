...
public interface zzvt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzvt {
        ...
        private static class C0762zza implements zzvt {
            private IBinder zzajq;

            C0762zza(IBinder iBinder) {
                this.zzajq = iBinder;
            }
        ...
        public static zzvt asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzvt)) ? new C0762zza(iBinder) : (zzvt) queryLocalInterface;
        }
