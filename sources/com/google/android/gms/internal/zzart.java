...
public final class zzart {
    ...
    public static int zzb(int i, zzasa zzasa) {
        return (zzahc(i) * 2) + zzd(zzasa);
    }
    ...
    public static int zzc(int i, zzasa zzasa) {
        return zzahc(i) + zze(zzasa);
    }
    ...
    public static int zzd(zzasa zzasa) {
        return zzasa.mo10838cz();
    }
    ...
    public static int zze(zzasa zzasa) {
        int cz = zzasa.mo10838cz();
        return cz + zzahe(cz);
    }
    ...
    /* renamed from: cl */
    public int mo10768cl() {
        return this.btF.remaining();
    }

    /* renamed from: cm */
    public void mo10769cm() {
        if (mo10768cl() != 0) {
    ...
    public void zza(int i, zzasa zzasa) throws IOException {
        zzaj(i, 2);
        zzc(zzasa);
    }
    ...
    public void zzb(zzasa zzasa) throws IOException {
        zzasa.zza(this);
    }
    ...
    public void zzc(zzasa zzasa) throws IOException {
        zzahd(zzasa.mo10837cy());
        zzasa.zza(this);
    }
