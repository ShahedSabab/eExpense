...
public class zzt implements zzf {
    ...
    private void zza(long j, zzk<?> zzk, byte[] bArr, StatusLine statusLine) {
        if (DEBUG || j > ((long) zzbn)) {
            ...
            objArr[4] = Integer.valueOf(zzk.zzs().zzd());
            zzs.zzb(str, objArr);
        }
    }
    ...
    private static void zza(String str, zzk<?> zzk, zzr zzr) throws zzr {
        ...
        try {
            zzs.zza(zzr);
            zzk.zzc(String.format("%s-retry [timeout=%s]", new Object[]{str, Integer.valueOf(zzr2)}));
        } catch (zzr e) {
            zzk.zzc(String.format("%s-timeout-giveup [timeout=%s]", new Object[]{str, Integer.valueOf(zzr2)}));
            throw e;
        }
    }
    ...
    public com.google.android.gms.internal.zzi zza(com.google.android.gms.internal.zzk<?> r19) throws com.google.android.gms.internal.zzr {
        ...
        L_0x0004:
            ...
            java.util.Map r6 = zza(r2)     // Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x013b }
        ...
        L_0x0065:
            ...
            org.apache.http.HttpEntity r2 = r15.getEntity()     // Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x013b }
            r0 = r18
            byte[] r11 = r0.zza(r2)     // Catch:{ SocketTimeoutException -> 0x0090, ConnectTimeoutException -> 0x00b1, MalformedURLException -> 0x00c0, IOException -> 0x013b }
        L_0x0075:
