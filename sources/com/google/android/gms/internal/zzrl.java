...
public interface zzrl extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzrl {
        ...
        private static class C0754zza implements zzrl {
            private IBinder zzajq;

            C0754zza(IBinder iBinder) {
                this.zzajq = iBinder;
            }
        ...
        public static zzrl zzdp(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzrl)) ? new C0754zza(iBinder) : (zzrl) queryLocalInterface;
        }
