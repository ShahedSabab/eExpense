...
import com.theartofdev.edmodo.cropper.BitmapUtils.DecodeBitmapResult;
...
final class BitmapLoadingWorkerTask extends AsyncTask<Void, Void, Result> {
    ...
    public Result doInBackground(Void... params) {
        try {
            if (!isCancelled()) {
                DecodeBitmapResult decodeResult = BitmapUtils.decodeSampledBitmap(this.mContext, this.mUri, this.mWidth, this.mHeight);
                if (!isCancelled()) {
