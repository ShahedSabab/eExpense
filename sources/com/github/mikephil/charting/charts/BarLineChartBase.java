...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    MPPointD pointForGetYValueByTouchPoint = MPPointD.getInstance(0.0d, 0.0d);
    ...
    public void zoomIn() {
        ...
        this.mViewPortHandler.zoomIn(center.f72x, -center.f73y, this.mZoomInMatrixBuffer);
    ...
    public void zoomOut() {
        MPPointF center = this.mViewPortHandler.getContentCenter();
        this.mViewPortHandler.zoomOut(center.f72x, -center.f73y, this.mZoomOutMatrixBuffer);
    ...
    public void zoomAndCenterAnimated(float scaleX, float scaleY, float xValue, float yValue, AxisDependency axis, long duration) {
        if (VERSION.SDK_INT >= 11) {
            ...
            addViewportJob(AnimatedZoomJob.getInstance(this.mViewPortHandler, this, getTransformer(axis), getAxis(axis), this.mXAxis.mAxisRange, scaleX, scaleY, this.mViewPortHandler.getScaleX(), this.mViewPortHandler.getScaleY(), xValue, yValue, (float) origin.f70x, (float) origin.f71y, duration));
    ...
    public void moveViewToAnimated(float xValue, float yValue, AxisDependency axis, long duration) {
        if (VERSION.SDK_INT >= 11) {
            ...
            float f = xValue;
            addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f, yValue + ((getDeltaY(axis) / this.mViewPortHandler.getScaleY()) / 2.0f), getTransformer(axis), this, (float) bounds.f70x, (float) bounds.f71y, duration));
    ...
    public void centerViewToAnimated(float xValue, float yValue, AxisDependency axis, long duration) {
        if (VERSION.SDK_INT >= 11) {
            MPPointD bounds = getValuesByTouchPoint(this.mViewPortHandler.contentLeft(), this.mViewPortHandler.contentTop(), axis);
            float xInView = getXAxis().mAxisRange / this.mViewPortHandler.getScaleX();
            addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, xValue - (xInView / 2.0f), ((getDeltaY(axis) / this.mViewPortHandler.getScaleY()) / 2.0f) + yValue, getTransformer(axis), this, (float) bounds.f70x, (float) bounds.f71y, duration));
            MPPointD.recycleInstance(bounds);
            return;
        }
    ...
    public float getYValueByTouchPoint(float x, float y, AxisDependency axis) {
        ...
        return (float) this.pointForGetYValueByTouchPoint.f71y;
    }
    ...
    public float getLowestVisibleX() {
        ...
        return (float) Math.max((double) this.mXAxis.mAxisMinimum, this.posForGetLowestVisibleX.f70x);
    }
    ...
    public float getHighestVisibleX() {
        ...
        return (float) Math.min((double) this.mXAxis.mAxisMaximum, this.posForGetHighestVisibleX.f70x);
    }
