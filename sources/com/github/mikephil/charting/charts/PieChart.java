...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    public void calculateOffsets() {
        ...
        if (this.mData != null) {
            ...
            this.mCircleBox.set((c.f72x - radius) + shift, (c.f73y - radius) + shift, (c.f72x + radius) - shift, (c.f73y + radius) - shift);
    ...
    public float[] getMarkerPosition(Highlight highlight) {
        ...
        float x = (float) ((((double) r2) * Math.cos(Math.toRadians((double) (((this.mAbsoluteAngles[entryIndex] + rotationAngle) - offset) * this.mAnimator.getPhaseY())))) + ((double) center.f72x));
        float y = (float) ((((double) r2) * Math.sin(Math.toRadians((double) (((this.mAbsoluteAngles[entryIndex] + rotationAngle) - offset) * this.mAnimator.getPhaseY())))) + ((double) center.f73y));
    ...
    public void setCenterTextOffset(float x, float y) {
        this.mCenterTextOffset.f72x = Utils.convertDpToPixel(x);
        this.mCenterTextOffset.f73y = Utils.convertDpToPixel(y);
    }

    public MPPointF getCenterTextOffset() {
        return MPPointF.getInstance(this.mCenterTextOffset.f72x, this.mCenterTextOffset.f73y);
    }
