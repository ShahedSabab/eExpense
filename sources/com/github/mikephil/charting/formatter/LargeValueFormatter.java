...
public class LargeValueFormatter implements ValueFormatter, AxisValueFormatter {
    ...
    private String makePretty(double number) {
        ...
        String r2 = r.replaceAll("E[0-9][0-9]", SUFFIX[Integer.valueOf(Character.getNumericValue(r.charAt(r.length() - 2)) + "" + Character.getNumericValue(r.charAt(r.length() - 1))).intValue() / 3]);
        while (true) {
