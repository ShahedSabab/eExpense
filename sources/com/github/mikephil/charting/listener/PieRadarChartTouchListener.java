        ...
        if (!this.mGestureDetector.onTouchEvent(event) && ((PieRadarChartBase) this.mChart).isRotationEnabled()) {
            ...
            switch (event.getAction()) {
                case 0:
                    ...
                    this.mTouchStartPoint.f72x = x;
                    this.mTouchStartPoint.f73y = y;
                    break;
                case 1:
                    if (((PieRadarChartBase) this.mChart).isDragDecelerationEnabled()) {
                        stopDeceleration();
                ...
                case 2:
                    ...
                    if (this.mTouchMode == 0 && distance(x, this.mTouchStartPoint.f72x, y, this.mTouchStartPoint.f73y) > Utils.convertDpToPixel(8.0f)) {
