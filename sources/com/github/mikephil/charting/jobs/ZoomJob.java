...
public class ZoomJob extends ViewPortJob {
    ...
    public static ZoomJob getInstance(ViewPortHandler viewPortHandler, float scaleX2, float scaleY2, float xValue, float yValue, Transformer trans, AxisDependency axis, View v) {
