...
public class Approximator {
    ...
    private class Line {
        ...
        private float f58dy;
        private float exsy;
        private float length = ((float) Math.sqrt((double) ((this.f57dx * this.f57dx) + (this.f58dy * this.f58dy))));
        ...
        public float distance(float x, float y) {
            return Math.abs((((this.f58dy * x) - (this.f57dx * y)) + this.sxey) - this.exsy) / this.length;
        }
